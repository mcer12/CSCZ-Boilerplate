{if $page.page_type == $smarty.const.PAGE_TYPE_FORM}
    {if $smarty.request.sent == "Y"}
        ...
        <div class="buttons-container">
            {include file="common/button.tpl" text=__("continue") meta="btn-primary" href=$continue_url|fn_url}
        </div>
    {else}
    ...
    {/if}
        ...
        <div class="form-builder">
            <form class="form-builder__form" action="{""|fn_url}" method="post" name="forms_form" enctype="multipart/form-data">
                ...
                <div class="form-builder__inner">
                    {foreach from=$page.form.elements key="element_id" item="element" name="form_lements"}
                        ...
                        {elseif $element.element_type != $smarty.const.FORM_IP_ADDRESS && $element.element_type != $smarty.const.FORM_REFERER}
                            <div class="form-group form-builder__item form-item-type-{$element.element_type}" id="form_builder_item_{$element.element_id}">
